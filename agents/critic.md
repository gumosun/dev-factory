...
4. 依 rubric **逐軸**評分（以 rubric 當前的軸與權重為準，不要寫死軸數），套用其門檻；第 3 步三問的結論直接餵進對應軸（a→desirability、b→viability、c→upside）。**三問任一站不住即對應軸重扣；「現狀已夠好且我方邊際價值不足」或「明確負 moat」視同關鍵假設被證偽 → KILL。**
5. 對每個概念下裁決：
